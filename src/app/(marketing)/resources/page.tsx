...
const GUIDES = [
  ...
  },
  {
    ...
    pitch:
      "The hardest call in a real incident: stand up the IMT or wait. Step through five trigger questions and get a recommendation, with the reasoning a regulator would want to read.",
    badge: "Interactive",
    icon: Compass,
  },
  {
